...
krs_ele_sel = mmil_readtext('/home/ekaestne/gitrep/MMIL/PROJECTS/XS/Figure5B.csv');
...
for iCL = 1:numel(tot_col)
    ...
    krs_chs_nme_hld{iCL} = strcat( krs_ele_sel( strcmpi( krs_ele_sel(:,5) , tot_col{iCL} ) , 1) , '_' , krs_ele_sel( strcmpi( krs_ele_sel(:,5) , tot_col{iCL} ) , 2) );
