...
krs_ele_sel = mmil_readtext('/home/ekaestne/gitrep/MMIL/PROJECTS/XS/SupplFig1_NY468.csv');
...
for iS = 1:numel(srf_sbj_nme)
    ...
    try
        frs_ele_loc_lhs = mmil_readtext( [ ele_loc '/' srf_sbj_nme '_' 'XS' '/' 'electrode_location' '/' 'NY468_fmri_072814_coor_T1_2014-08-15_edited.txt' ] );
    catch
        frs_ele_loc_lhs = [];
    end
    
    try
        frs_ele_loc_rhs = mmil_readtext( [ ele_loc '/' srf_sbj_nme '_' 'XS' '/' 'electrode_location' '/' 'NY468_fmri_072814_coor_T1_2014-08-15_edited.txt' ] );
    catch
        frs_ele_loc_rhs = [];
    end
