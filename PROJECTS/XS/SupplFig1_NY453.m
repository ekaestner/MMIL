...
krs_ele_sel = mmil_readtext('/home/ekaestne/gitrep/MMIL/PROJECTS/XS/SupplFig1_NY453.csv');
...
for iS = 1:numel(srf_sbj_nme)
    ...
    try
        frs_ele_loc_lhs = mmil_readtext( [ ele_loc '/' srf_sbj_nme '_' 'XS' '/' 'electrode_location' '/' 'NY453_fmri_051614_coor_T1_2014-06-02_edited.txt' ] );
    catch
        frs_ele_loc_lhs = [];
    end
    
    try
        frs_ele_loc_rhs = mmil_readtext( [ ele_loc '/' srf_sbj_nme '_' 'XS' '/' 'electrode_location' '/' 'NY453_fmri_051614_coor_T1_2014-06-02_edited.txt' ] );
    catch
        frs_ele_loc_rhs = [];
    end
