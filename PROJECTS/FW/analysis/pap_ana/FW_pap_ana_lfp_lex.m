function FW_pap_ana_lfp_lex(fcfg)
...
cfg.sig_loc = { { 'vis_old' 'vis_wrd_big' 'vis_wrd_frq' 'vis_stm_01' 'fw_wrd_stt' 'fw_rep_stt'} };
...
cfg.tbl_cmb_rul = { { '1 & 4 & ( 5 | 6 )'  '2 & 4 & ( 5 | 6 )' '3 & 4 & ( 5 | 6 )' '( ( 1 | 2 | 3 ) & ( ~ 4 | ~ ( 5 | 6 ) ) )'} };
...
cfg.plt_prb_cmb_rul = { { '1 & 4 & ( 5 | 6 )'  '2 & 4 & ( 5 | 6 )' '3 & 4 & ( 5 | 6 )' '( ( 1 | 2 | 3 ) & ( ~ 4 | ~ ( 5 | 6 ) ) ) '} };
