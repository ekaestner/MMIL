...
fcfg.ana_nme = { 'pap_rsp_600' 'pap_wrd_600' 'pap_wrd_600' 'pap_con_600'};
fcfg.ana_clm = [ 1              1             2             1 ];
fcfg.eff_clm = { 1             [1 3]         3             1 };

fcfg.ana_col = { 'black'       'purple' 'red'  'reddish grey'};
fcfg.ana_lbl = { 'responsive'  'letter' 'word' 'false-font'};
