...
sbj_grp_col = {   'Diagnosis'                                'Onset' };
sbj_grp_nme = { { 'HC'       'MCI'         'EPD_Old' }     { 'HC'       'MCI'         'Early'       'Late' } };
sbj_grp_clr = { { [.8 .8 .8] [.47 .31 .45] [.34 .59 .64] } { [.8 .8 .8] [.47 .31 .45] [.63 .77 .80] [.00 .33 .37] } };

num_rep = 5000;
pvl_lvl = .01;
pvl_con = {   'HC'               'HC' };
pvl_cmp = { { 'MCI' 'EPD_Old'} { 'MCI'         'Early'       'Late' } };
lve_num_out = 3;
