...
run_typ = { [ 1 1 2 1 1 ] ... % epd,          pre,  3T, Non-Surgical, all patients 
            ...
            ...
            [ 1 1 1 1 1 ] ... % epd,          pre,  allT, Non-Surgical, all patients 
            [ 1 1 1 1 2 ] ... % epd,          pre,  allT, Non-Surgical, L/R split 
            [ 1 1 1 2 1 ] ... % epd,          pre,  allT, ATL,          all patients 
            [ 1 1 1 2 2 ] ... % epd,          pre,  allT, ATL,          L/R split
            [ 1 2 1 2 1 ] ... % epd,          post, allT, ATL,          all patients 
            [ 1 2 1 2 2 ] ... % epd,          post, allT, ATL,          L/R split
            [ 2 1 1 1 1 ] ... % controls/epd, pre,  allT, Non-Surgical, all patients 
            [ 3 1 1 1 1 ] ... % controls,     pre,  allT, Non-Surgical, all  
            [ 2 1 1 1 3 ] ... % controls/epd, pre,  allT, Non-Surgical, L/R split including controls
            }; 
