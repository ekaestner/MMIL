...
%% 
bnt_pre_scr_col = find(strcmpi( prd_dta_col, 'xbnt_raw_scr' ));
ant_pre_scr_col = find(strcmpi( prd_dta_col, 'xant_mem_raw_scr' ));
...
for iT = 1:numel(cog_nme)
    for iN = 1:numel(mes_nme)
        ...
        fcfg.out_dir = '/home/ekaestner/Dropbox/McDonald Lab/Erik/Projects/McDLab/pst_opr/Naming/Manuscript/Figures/Figure3/';
