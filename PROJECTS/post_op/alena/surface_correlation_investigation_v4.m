...
sbj_num_nme = { 'n18'    'n21'  };
       grp_nme = { '3_left' 'left' }; % { 'dominant' 'dominant' }; % { '3_left_dominant' 'left_dominant' }; % grp_nme = { '3_left' 'left' };

%% Run  %%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%
tst_num_use = 3; % [ 1 2 3 4 5 ]
cov_typ_use = 2; % [ 1 2 3 ]
sbj_num_use = 2; % [ 1 2 ]
...
fcfg.dta_lhs = [ '/home/ekaestne/PROJECTS/OUTPUT/PostOperative/Naming/Data' '/' 'surf_wmparc_fa_lhs_sm' num2str(smt_stp) '.mat']; % [ dta_dir '/' 'surf_wmparc_fa_lhs_sm' num2str(smt_stp) '_epd006switch_epd096add.mat']
fcfg.dta_rhs = [ '/home/ekaestne/PROJECTS/OUTPUT/PostOperative/Naming/Data' '/' 'surf_wmparc_fa_rhs_sm' num2str(smt_stp) '.mat']; % [ dta_dir '/' 'surf_wmparc_fa_rhs_sm' num2str(smt_stp) '_epd006switch_epd096add.mat']
...
fcfg.out_pre = [out_pre_fix '_' 'ATL_only_Raw_new_data'];
