...
%% Setup
dta_loc = { [ prj_dir '/' prj_nme '/' 'SpecificCor/MRI/subcort_vol_ICV_cor/Raw/tle_controls_pre_3T_allSurg_all' '/' ] ...
            ...
            [ prj_dir '/' prj_nme '/' 'SpecificCor/MRI/cort_thick_ctx/Raw/tle_controls_pre_3T_allSurg_all' '/' ] };
...
%% Save Table
cell2csv( [ out_dir '/' 'Table_misc_presurgical.csv' ], out_tbl)
cell2csv( [ out_dir '/' 'Table_misc_presurgical_stats.csv' ], out_stt)