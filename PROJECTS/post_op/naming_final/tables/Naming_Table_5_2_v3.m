...
%% Setup
dta_loc = { [ prj_dir '/' prj_nme '/' 'SpecificCor/Clinical/Correlation/RTLE_post_cln'  '/' ] ...
            [ prj_dir '/' prj_nme '/' 'SpecificCor/MRI/subcort_vol_ICV_cor/Raw/tle_post_3T_ATLonly_right' '/' ] ...
            ...
            [ prj_dir '/' prj_nme '/' 'SpecificCor/Cognitive/Correlation/RTLE_pre_post' '/' ] };
