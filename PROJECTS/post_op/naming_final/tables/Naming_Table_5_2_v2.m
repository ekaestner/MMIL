...
clear dta_inp
dta_inp{1} = mmil_readtext('/home/ekaestne/PROJECTS/OUTPUT/PostOperative/Naming_final/SpecificCor/MRI/subcort_vol_ICV_cor/Raw/tle_post_3T_ATLonly_right/cross_correlation_rvalues.csv');
dta_inp{2} = mmil_readtext('/home/ekaestne/PROJECTS/OUTPUT/PostOperative/Naming_final/SpecificCor/MRI/subcort_vol_ICV_cor/Raw/tle_post_3T_ATLonly_right/cross_correlation_rvalues.csv');
dta_inp{3} = mmil_readtext('/home/ekaestne/PROJECTS/OUTPUT/PostOperative/Naming_final/SpecificCor/DTI/fiber_FA/Raw/tle_post_3T_ATLonly_right/cross_correlation_rvalues.csv');
dta_inp{4} = mmil_readtext('/home/ekaestne/PROJECTS/OUTPUT/PostOperative/Naming_final/SpecificCor/DTI/wmparc_FA_wm/Raw/tle_post_3T_ATLonly_right/cross_correlation_rvalues.csv');
...
clear dta_inp
dta_inp{1} = mmil_readtext('/home/ekaestne/PROJECTS/OUTPUT/PostOperative/Naming_final/SpecificCor/MRI/subcort_vol_ICV_cor/Raw/tle_post_3T_ATLonly_right/cross_correlation_pvalues.csv');
dta_inp{2} = mmil_readtext('/home/ekaestne/PROJECTS/OUTPUT/PostOperative/Naming_final/SpecificCor/MRI/subcort_vol_ICV_cor/Raw/tle_post_3T_ATLonly_right/cross_correlation_pvalues.csv');
dta_inp{3} = mmil_readtext('/home/ekaestne/PROJECTS/OUTPUT/PostOperative/Naming_final/SpecificCor/DTI/fiber_FA/Raw/tle_post_3T_ATLonly_right/cross_correlation_pvalues.csv');
dta_inp{4} = mmil_readtext('/home/ekaestne/PROJECTS/OUTPUT/PostOperative/Naming_final/SpecificCor/DTI/wmparc_FA_wm/Raw/tle_post_3T_ATLonly_right/cross_correlation_pvalues.csv');
...
clear dta_inp
dta_inp{1} = mmil_readtext('/home/ekaestne/PROJECTS/OUTPUT/PostOperative/Naming_final/SpecificCor/Summary/apriori/include_total_raw_tle_post_3T_ATLonly_right_FDR.csv');
