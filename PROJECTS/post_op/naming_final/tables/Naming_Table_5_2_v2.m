...
clear dta_inp
dta_inp{1} = mmil_readtext([ prj_dir '/' prj_nme '/' '/SpecificCor/MRI/subcort_vol_ICV_cor/Raw/tle_post_3T_ATLonly_right/cross_correlation_rvalues.csv']);
...
clear dta_inp
dta_inp{1} = mmil_readtext([ prj_dir '/' prj_nme '/' '/SpecificCor/MRI/subcort_vol_ICV_cor/Raw/tle_post_3T_ATLonly_right/cross_correlation_pvalues.csv']);
