...
%% Setup
dta_loc = { [ prj_dir '/' prj_nme '/' 'SpecificCor/MRI/subcort_vol_ICV_cor/Raw/tle_post_3T_ATLonly_left' '/' ] ...
            ...
            [ prj_dir '/' prj_nme '/' 'SpecificCor/MRI/cort_thick_ctx/Raw/tle_post_3T_ATLonly_left' '/' ] };
...
%% Save Table
cell2csv( [ out_dir '/' 'Table_misc_postsurgical_ltle.csv' ], out_tbl)
cell2csv( [ out_dir '/' 'Table_misc_postsurgical_ltle_stats.csv' ], out_stt)