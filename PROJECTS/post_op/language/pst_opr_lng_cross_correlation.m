...
%%
out_put = '/home/ekaestne/PROJECTS/OUTPUT/PostOperative/Language/CrossCorrelation/';

cln_fle     = [ '/home/ekaestne/PROJECTS/OUTPUT/PostOperative/Language/Data' '/' 'Clinical.csv' ];

cog_fle     = '/home/ekaestne/PROJECTS/OUTPUT/PostOperative/Language/Data/Cognitive_exclude.csv';
...
%% fMRI
ts3_lft_fmr = intersect(ts3_lft, fmr_inc);
ts3_rgh_fmr = intersect(ts3_rgh, fmr_inc); 
...
for iN = 1:numel(fmr_mse)
    for iR = 1:numel(fmr_roi_use{iN})
        ...
        fcfg.dta_one = cell2mat(fmr_dta( ts3_lft_fmr, :));
        ...
        fcfg.out_dir = [ out_put '/' 'fMRI' '/' fmr_mse{iN} '/' 'Raw' '/'];
        ...
        fcfg.dta_one = cell2mat(fmr_dta_lat( ts3_lft_fmr, :));
        ...
        fcfg.out_dir = [ out_put '/' 'fMRI' '/' fmr_mse{iN} '/' 'LI' '/'];
