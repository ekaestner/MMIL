function iSASZ_analysis_auditory_lfp(fcfg)
...
% 
% cfg.sig_loc = { { 'aud_ani_obj_stt_msk' 'aud_ovr_stt'} };
%            
% cfg.sig_chn = { [ 1 1 ] };
% 
% % Table Combination
% cfg.run_tbl     = [1];
% 
% cfg.tbl_cmb_nme = { { 'Auditory Animal-Object Sensitive' } };
%                
% cfg.tbl_cmb_rul = { { '1 & 2' } };
%                
% cfg.tbl_sum = { [] };
...
% cfg.run_plt     = [1];
% 
% cfg.plt_cmb_nme = { { 'Auditory Animal-Object Sensitive' } };
%                
% cfg.plt_cmb_col = { { 'bright blue' } };
%                
% cfg.plt_cmb_rul     = { { '1 & 2' } };
...
% cfg.run_fst     = [ 1 ];
% 
% cfg.fst_cmb_nme = { { 'Auditory Animal-Object Sensitive' } };
%                
% cfg.fst_cmb_col = { { 'aqua' } };
%                
% cfg.fst_cmb_rul = { { '1' '2' } };
%                
% cfg.fst_ord     = {{}};
...
% cfg.run_tme     = [0];
% 
% cfg.tme_cmb_nme = { { 'Auditory Animal-Object Sensitive' } };
%                
...
cfg.sig_loc = { { 'aud_new_old_stt_msk' 'aud_ovr_stt' } };
...
cfg.tbl_cmb_nme = { { 'Auditory Novel-Repetition Sensitive' } };
...
cfg.plt_cmb_nme = { { 'Auditory Novel-Repetition Sensitive' } };
...
cfg.fst_cmb_nme = { { 'Auditory Novel-Repetition Sensitive' } };
