function iSASZ_analysis_visual_lfp(fcfg)
...
cfg.sig_loc = { { 'vis_ani_obj_stt_msk' 'vis_ovr_stt' } };
...
cfg.tbl_cmb_nme = { { 'Visual Animal-Object Sensitive' } };
...
cfg.plt_cmb_nme = { { 'Visual Animal-Object Sensitive' } };
               
cfg.plt_cmb_col = { { 'rust' } };
...
cfg.fst_cmb_nme = { { 'Visual Animal-Object Sensitive' } };
               
cfg.fst_cmb_col = { { 'rust' } };
...
cfg.sig_loc = { { 'vis_new_old_stt_msk' 'vis_ovr_stt'} };
...
cfg.tbl_cmb_nme = { { 'Visual Novel-Repetition Sensitive'} };
...
cfg.plt_cmb_nme = { { 'Visual Novel-Repetition Sensitive' } };
               
cfg.plt_cmb_col = { { 'bright red' } };
...
cfg.fst_cmb_nme = { { 'Visual Novel-Repetition Sensitive' } };
