...
fcfg.reg     = reg;
fcfg.typ     = 'bet_reg';
fcfg.loc_nme = {'pap_vis_act' 'pap_aud_act' 'pap_bim_act' };
fcfg.hms     = {'lhs' 'lhs'};
fcfg.col     = {[2 3]         [2 3]         [2 3]};
fcfg.plt     = 1;
fcfg.out_plt = [fcfg.clr_fld '/' 'manuscript' '/' 'figure2' '/' 'Fisher' '/' 'UniModal'];
bet_lhs_act = mmil_fisher_exact_region_test(fcfg);

spc_tst = [ bet_lhs_act.cmb_reg.VisualResponsive.pvl{9,1} bet_lhs_act.cmb_reg.VisualResponsive.pvl{1,6}  bet_lhs_act.cmb_reg.VisualResponsive.pvl(9,6) ; ...
            bet_lhs_act.cmb_reg.VisualResponsive.pvl{9,1} bet_lhs_act.cmb_reg.VisualResponsive.pvl{1,7}  bet_lhs_act.cmb_reg.VisualResponsive.pvl(9,7) ; ...
            bet_lhs_act.cmb_reg.VisualResponsive.pvl{9,1} bet_lhs_act.cmb_reg.VisualResponsive.pvl{1,10} bet_lhs_act.cmb_reg.VisualResponsive.pvl(9,10) ]
[bet_lhs_act.cmb_reg.VisualResponsive.pvl([1 end],:) ; bet_lhs_act.cmb_reg.VisualResponsive.pvl_cnv(end,:)]
% 
% spc_tst = [ bet_lhs_act.cmb_reg.AuditoryResponsive.pvl{9,1} bet_lhs_act.cmb_reg.AuditoryResponsive.pvl{1,6}  bet_lhs_act.cmb_reg.AuditoryResponsive.pvl(9,6) ; ...
%             bet_lhs_act.cmb_reg.AuditoryResponsive.pvl{9,1} bet_lhs_act.cmb_reg.AuditoryResponsive.pvl{1,7}  bet_lhs_act.cmb_reg.AuditoryResponsive.pvl(9,7) ; ...
%             bet_lhs_act.cmb_reg.AuditoryResponsive.pvl{9,1} bet_lhs_act.cmb_reg.AuditoryResponsive.pvl{1,10} bet_lhs_act.cmb_reg.AuditoryResponsive.pvl(9,10) ]
% [bet_lhs_act.cmb_reg.AuditoryResponsive.pvl([1 end],:) ; bet_lhs_act.cmb_reg.AuditoryResponsive.pvl_cnv(end,:)]

% spc_tst = [ bet_lhs_act.cmb_reg.BimodalResponsive.pvl{9,1} bet_lhs_act.cmb_reg.BimodalResponsive.pvl{1,6}  bet_lhs_act.cmb_reg.BimodalResponsive.pvl(9,6) ; ...
%             bet_lhs_act.cmb_reg.BimodalResponsive.pvl{9,1} bet_lhs_act.cmb_reg.BimodalResponsive.pvl{1,7}  bet_lhs_act.cmb_reg.BimodalResponsive.pvl(9,7) ; ...
%             bet_lhs_act.cmb_reg.BimodalResponsive.pvl{9,1} bet_lhs_act.cmb_reg.BimodalResponsive.pvl{1,10} bet_lhs_act.cmb_reg.BimodalResponsive.pvl(9,10) ]
% [bet_lhs_act.cmb_reg.BimodalResponsive.pvl([1 end],:) ; bet_lhs_act.cmb_reg.BimodalResponsive.pvl_cnv(end,:)]
...
fcfg.plt     = 1;
fcfg.out_plt = [fcfg.clr_fld '/' 'manuscript' '/' 'figure2' '/' 'Fisher' '/' 'UniModal' '/'];
hms_sig_act = mmil_fisher_exact_region_test(fcfg);

hms_sig_act.cmb_reg.VisualResponsive
hms_sig_act.cmb_reg.AuditoryResponsive
hms_sig_act.cmb_reg.BimodalResponsive
...
fcfg.reg     = reg;
fcfg.typ     = 'wth_reg';
fcfg.loc_nme = { 'pap_vis_act' 'pap_aud_act' };
fcfg.hms     = { 'lhs' 'lhs'};
fcfg.col     = { [2 3]          [2 3]};
fcfg.use_col = { [1 2] };
fcfg.plt     = 1;
...
% wth_rhs_act = mmil_fisher_exact_region_test(fcfg);
...
% fcfg.plt     = 1;
% fcfg.out_plt = [fcfg.clr_fld '/' 'manuscript' '/' 'figure2' '/' 'Fisher' '/'];
% bet_rhs_act = mmil_fisher_exact_region_test(fcfg);
...
% Overlap Regions
pap_vis_act = mmil_readtext('/space/mdeh4/1/halgdev/projects/mmilanguage/iSASZ/clerical/sig_chn/hgp/ecog/split/pap_vis_act/subjects/total/pap_vis_act_plt');
pap_vis_act = pap_vis_act(2:end,:);

pap_aud_act = mmil_readtext('/space/mdeh4/1/halgdev/projects/mmilanguage/iSASZ/clerical/sig_chn/hgp/ecog/split/pap_aud_act/subjects/total/pap_aud_act_plt');
pap_aud_act = pap_aud_act(2:end,:);
...
cfg.tot_ele = tot_ele;
cfg.ecg_hms = {'lhs' 'rhs'};
cfg.eff_ele = [pap_vis_act(2:end,2) pap_vis_act(2:end,3) pap_aud_act(2:end,3)];
