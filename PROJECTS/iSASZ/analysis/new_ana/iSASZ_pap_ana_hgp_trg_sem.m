function iSASZ_pap_ana_hgp_trg_sem(fcfg)

fprintf([fcfg.sbj_nme ': Starting iSASZ_pap_ana_hgp_trg_sem on %s \n'],fcfg.sbj_nme)
...
if any(eve_typ < 9)
    ...
    cfg.cmb_nme = { 'pap_vis_trg_sem' };
    
    cfg.sig_loc = { { 'vis_new_ovr_stt' 'vis_new_ovr_stt' 'vis_sem_mot_mnp_stt_msk_ovr' 'vis_sem_mot_mnp_stt_msk_ovr' 'vis_sem_mot_mnp_stt_msk_ovr' 'vis_sem_mot_mnp_stt_msk_ovr' } };
    ...
    cfg.alt_eve = { { 'sem_mot_mnp' } };
    cfg.eve     = { { [901 902] } };
    cfg.lnstyle.col_ord = { { { rgb('green') rgb('reddish gray') } } };
    
    cfg.stt_dat = { { {'vis_new_ovr_stt' 'vis_sem_mot_mnp_stt_msk_ovr' } } };
...
if any(eve_typ > 9)
    ...
    cfg.cmb_nme = { 'pap_aud_trg_sem' };
    
    cfg.sig_loc = { { 'aud_new_ovr_stt' 'aud_new_ovr_stt' 'aud_sem_mot_mnp_stt_msk_ovr' 'aud_sem_mot_mnp_stt_msk_ovr' 'aud_sem_mot_mnp_stt_msk_ovr' 'aud_sem_mot_mnp_stt_msk_ovr' } };
    ...
    cfg.stt_dat = { { {'aud_new_ovr_stt' 'aud_sem_mot_mnp_stt_msk_ovr' } } };
    cfg.stt_col = { { { ft_stt_col(rgb('reddish gray')) ft_stt_col(rgb('green'))} } };
    cfg.stt_cmp = { { { '0%3'   '3%6'} } };
...
if any(eve_typ < 9) && any(eve_typ > 9)
    ...
    cfg.cmb_nme = { 'pap_bim_trg_sem' };
    
    cfg.sig_loc = { { 'vis_new_ovr_stt' 'vis_new_ovr_stt' 'vis_sem_mot_mnp_stt_msk_ovr' 'vis_sem_mot_mnp_stt_msk_ovr' 'vis_sem_mot_mnp_stt_msk_ovr' 'vis_sem_mot_mnp_stt_msk_ovr' 'aud_new_ovr_stt' 'aud_new_ovr_stt' 'aud_sem_mot_mnp_stt_msk_ovr' 'aud_sem_mot_mnp_stt_msk_ovr' 'aud_sem_mot_mnp_stt_msk_ovr' 'aud_sem_mot_mnp_stt_msk_ovr' } };
    ...
    cfg.alt_eve = { { 'sem_mot_mnp' 'sem_mot_mnp' ; '' ''} };
    cfg.eve     = { { [901 902] [911 912] ; [] [] } };
    cfg.lnstyle.col_ord = { { { rgb('green') rgb('reddish gray') } { rgb('bluish green') rgb('bluish grey') } ; {} {} } };
    
    cfg.stt_dat = { { {'vis_new_ovr_stt' 'vis_sem_mot_mnp_stt_msk_ovr' } {'aud_new_ovr_stt' 'aud_sem_mot_mnp_stt_msk_ovr'} ; {} {}} };
