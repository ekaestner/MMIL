...
if any(eve_typ < 9)
    ...
    cfg.cmb_nme = { 'pap_vis_rep_nob' };
    
    cfg.sig_loc = { { 'vis_new_ovr_stt' 'vis_new_ovr_stt' 'vis_new_old_stt' 'vis_new_old_stt'} };
    ...
    cfg.stt_dat = { { {'vis_new_ovr_stt' 'vis_new_old_stt' } } };
...
if any(eve_typ > 9)
    ...
    cfg.cmb_nme = { 'pap_aud_rep_nob' };
    
    cfg.sig_loc = { { 'aud_new_ovr_stt' 'aud_new_ovr_stt' 'aud_new_old_stt' 'aud_new_old_stt'} };
    ...
    cfg.stt_dat = { { {'aud_new_ovr_stt' 'aud_new_old_stt' } } };
...
if any(eve_typ < 9) && any(eve_typ > 9)
    ...
    cfg.cmb_nme = { 'pap_bim_rep_nob' };
    
    cfg.sig_loc = { { 'vis_new_ovr_stt' 'vis_new_ovr_stt' 'aud_new_ovr_stt' 'aud_new_ovr_stt' 'vis_new_old_stt' 'vis_new_old_stt' 'aud_new_old_stt' 'aud_new_old_stt' } };
    ...
    cfg.stt_dat = { { {'vis_new_ovr_stt' 'vis_new_old_stt' } {'aud_new_ovr_stt' 'aud_new_old_stt'} ; {} {}} };
