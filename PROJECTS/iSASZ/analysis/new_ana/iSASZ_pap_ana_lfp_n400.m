function iSASZ_pap_ana_lfp_n400(fcfg)

fprintf([fcfg.sbj_nme ': Starting iSASZ_pap_ana_lfp_n400 on %s \n'],fcfg.sbj_nme)
...
if any(eve_typ < 9)
    ...
    cfg.tbl_cmb_nme = { { 'VisualN400' 'TotalVisualN400' 'N400Corrected'} };
    ...
    cfg.plt_cmb_nme = { { 'VisualN400' 'TotalVisualN400' } };
    cfg.plt_cmb_col = { { 'bright red' 'dark red' } };
    
    cfg.plt_pct_cmb_nme = { { 'VisualN400' 'TotalVisualN400' 'N400Corrected'} };
    ...
    cfg.fst_cmb_nme = { { 'VisualResponsive' 'VisualN400' } };
...
if any(eve_typ > 9)
    ...
    cfg.tbl_cmb_nme = { { 'AuditoryN400' 'TotalAuditoryN400' 'N400Corrected'} };
    ...
    cfg.plt_cmb_nme = { { 'AuditoryN400' 'TotalAuditoryN400' } };
    cfg.plt_cmb_col = { { 'bright blue' 'bluish grey' } };
    
    cfg.plt_pct_cmb_nme = { { 'AuditoryN400' 'TotalAuditoryN400' 'N400Corrected'} };
...
if any(eve_typ < 9) && any(eve_typ > 9)
    ...
    cfg.tbl_cmb_nme = { { 'BimodalN400' 'TotalBimodalN400' 'BimodalCorrected' } };
    ...
    cfg.plt_cmb_nme = { { 'BimodalN400' 'TotalBimodalN400'  } };
    cfg.plt_cmb_col = { { 'bright purple' 'purplish grey' } };
    
    cfg.plt_pct_cmb_nme = { { 'BimodalN400' 'TotalBimodalN400' 'BimodalCorrected' } };
