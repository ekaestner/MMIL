function iSASZ_word_char_analysis_auditory_lfp(fcfg)
...
cfg.sig_loc = { { 'aud_ovr_stt' 'aud_lng_stt' 'aud_big_lng_stt' 'aud_frq_lng_stt' 'aud_ngh_lng_stt' } };
...
cfg.sig_loc = { { 'aud_ovr_stt' 'aud_big_stt' 'aud_lng_big_stt' 'aud_frq_big_stt' 'aud_ngh_big_stt' } };
...
cfg.sig_loc = { { 'aud_ovr_stt' 'aud_frq_stt' 'aud_lng_frq_stt' 'aud_big_frq_stt' 'aud_ngh_frq_stt' } };
...
cfg.sig_loc = { { 'aud_ovr_stt' 'aud_ngh_stt' 'aud_lng_ngh_stt' 'aud_big_ngh_stt' 'aud_frq_ngh_stt' } };
