function iSASZ_word_char_analysis_visual_lfp(fcfg)
...
cfg.sig_loc = { { 'vis_ovr_stt' 'vis_lng_stt' 'vis_big_lng_stt' 'vis_frq_lng_stt' 'vis_ngh_lng_stt' } };
...
cfg.tbl_cmb_rul = { { '1 & 2' '1 & 2 & ( 3 | 4 | 5 )' '~ 1 & 2 ' } };
...
cfg.plt_cmb_rul     = { { '1 & 2' '1 & 2 & ( 3 | 4 | 5 )' '~ 1 & 2 ' } };
cfg.plt_prb_cmb_rul = { { '1 & 2' '1 & 2 & ( 3 | 4 | 5 )' '~ 1 & 2 ' } };
...
cfg.sig_loc = { { 'vis_ovr_stt' 'vis_big_stt' 'vis_lng_big_stt' 'vis_frq_big_stt' 'vis_ngh_big_stt' } };
...
cfg.sig_loc = { { 'vis_ovr_stt' 'vis_frq_stt' 'vis_lng_frq_stt' 'vis_big_frq_stt' 'vis_ngh_frq_stt' } };
...
cfg.sig_loc = { { 'vis_ovr_stt' 'vis_ngh_stt' 'vis_lng_ngh_stt' 'vis_big_ngh_stt' 'vis_frq_ngh_stt' } };
