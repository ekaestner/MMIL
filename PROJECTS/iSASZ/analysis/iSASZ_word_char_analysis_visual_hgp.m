function iSASZ_word_char_analysis_visual_hgp(fcfg)
...
cfg.cmb_nme = { 'vis_lng_crr_600' };

cfg.sig_loc = { { 'vis_ovr_stt' 'vis_lng_stt' 'vis_lng_stt' 'vis_big_lng_stt' 'vis_big_lng_stt' 'vis_frq_lng_stt' 'vis_frq_lng_stt' 'vis_ngh_lng_stt' 'vis_ngh_lng_stt' } };
...
cfg.alt_eve = { {           'vis_new_old'                      'vis_lng_med'                       'vis_big_med' ; ''                         'vis_frq_med'                             'vis_ngh_med' ; '' '' '' } };
cfg.eve     = { {           [111 112]                          [131 132]                           [141 142] ; []                             [151 152]                                 [161 162] ; [] [] [] } };
...
cfg.stt_dat = { { { 'vis_ovr_stt'           'vis_new_old_stt_msk'}     {'vis_lng_stt'          'vis_lng_big_stt'       'vis_lng_frq_stt'         'vis_lng_ngh_stt'}         {'vis_big_stt'           'vis_big_lng_stt'      'vis_big_frq_stt'       'vis_big_ngh_stt'}         ; {} {'vis_frq_stt'             'vis_frq_lng_stt'      'vis_frq_big_stt'       'vis_frq_ngh_stt'}         {'vis_ngh_stt'             'vis_ngh_lng_stt'      'vis_ngh_big_stt'       'vis_ngh_frq_stt'} ; {} {} {} } };
...
cfg.cmb_nme = { 'vis_big_crr_600' };

cfg.sig_loc = { { 'vis_ovr_stt' 'vis_big_stt' 'vis_big_stt' 'vis_lng_big_stt' 'vis_lng_big_stt' 'vis_frq_big_stt' 'vis_frq_big_stt' 'vis_ngh_big_stt' 'vis_ngh_big_stt' } };
...
cfg.cmb_nme = { 'vis_frq_crr_600' };

cfg.sig_loc = { { 'vis_ovr_stt' 'vis_frq_stt' 'vis_frq_stt' 'vis_lng_frq_stt' 'vis_lng_frq_stt' 'vis_big_frq_stt' 'vis_big_frq_stt' 'vis_ngh_frq_stt' 'vis_ngh_frq_stt' } };
...
cfg.cmb_nme = { 'vis_ngh_crr_600' };

cfg.sig_loc = { { 'vis_ovr_stt' 'vis_ngh_stt' 'vis_ngh_stt' 'vis_lng_ngh_stt' 'vis_lng_ngh_stt' 'vis_big_ngh_stt' 'vis_big_ngh_stt' 'vis_frq_ngh_stt' 'vis_frq_ngh_stt'  } };
