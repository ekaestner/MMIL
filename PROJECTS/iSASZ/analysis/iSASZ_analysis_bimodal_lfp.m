function iSASZ_analysis_bimodal_lfp(fcfg)

fprintf([fcfg.sbj_nme ': Starting initial bimdoal analysis work on %s \n'],fcfg.sbj_nme)
...
cfg.cmb_nme = { 'ani_obj_800_bim' };

cfg.sig_loc = { { 'vis_ani_obj_stt_msk' 'aud_ani_obj_stt_msk' 'vis_ovr_stt' 'aud_ovr_stt'} };
...
cfg.tbl_cmb_nme = { { 'Visual Animal-Object Sensitive' 'Auditory Animal-Object Sensitive' 'Bi-Modal Animal-Object Sensitive' } };
...
cfg.plt_cmb_nme = { { 'Visual Animal-Object Sensitive' 'Auditory Animal-Object Sensitive' 'Bi-Modal Animal-Object Sensitive' } };
               
cfg.plt_cmb_col = { { 'rust' 'yellow' 'indigo' } };
...
cfg.fst_cmb_nme = { { 'Visual Semantic' 'Auditory Semantic' } };
               
cfg.fst_cmb_col = { { 'rust'            'yellow' } };
...
cfg.cmb_nme = { 'nov_rep_800_bim' };

cfg.sig_loc = { { 'vis_new_old_stt_msk' 'aud_new_old_stt_msk' 'vis_ovr_stt' 'aud_ovr_stt' } };
...
cfg.tbl_cmb_nme = { { 'Visual Novel-Repetition Sensitive' 'Auditory Novel-Repetition Sensitive' 'Bi-Modal Novel-Repetition Sensitive' } };
...
cfg.plt_cmb_nme = { { 'Visual Novel-Repetition Sensitive' 'Auditory Novel-Repetition Sensitive' 'Bi-Modal Novel-Repetition Sensitive' } };
               
cfg.plt_cmb_col = { { 'bright red' 'bright blue' 'purple' } };
...
cfg.fst_cmb_nme = { { 'Visual Novel-Repetition Sensitive' 'Auditory Novel-Repetition Sensitive' } };
