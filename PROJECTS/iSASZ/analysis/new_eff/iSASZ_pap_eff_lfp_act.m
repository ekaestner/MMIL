function iSASZ_pap_ana_lfp_act(fcfg)
...
if any(eve_typ < 9)
    ...
    cfg.cmp_trl = { 'vis_new_bse' };
    cfg.cmp_stt = { [ 1 1 ] };
    cfg.cmp_nme = { { 'vis_ovr_500ms' 'vis_ovr_1200ms'} };
    cfg.cmp     = { { '102!999' '102!999' } };
    cfg.tme_win = { { [0.025 0.500] [0.025 1.200] } };
    cfg.stt_col = { { 'reddish grey' 'reddish grey' } };
...
if any(eve_typ > 9)
    ...
    cfg.alt_stt = { 'aud_new_ovr_stt' };
    cfg.cmp_trl = { 'aud_new_bse' };
    cfg.cmp_stt = { [ 1 1 ] };
    cfg.cmp_nme = { { 'aud_ovr_500ms' 'aud_ovr_1200ms'} };
    cfg.cmp     = { { '202!999' '202!999' } };
    cfg.tme_win = { { [0.025 0.500] [0.025 1.200] } };
    cfg.stt_col = { { 'reddish grey' 'reddish grey' } };
