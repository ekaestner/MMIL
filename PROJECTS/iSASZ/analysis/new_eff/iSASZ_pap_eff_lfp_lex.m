function iSASZ_pap_eff_lfp_lex(fcfg)

fprintf([fcfg.sbj_nme ': Starting iSASZ_pap_eff_lfp_lex on %s \n'],fcfg.sbj_nme)
...
if any(eve_typ < 9)
    ...
    cfg.alt_stt = { 'vis_frq_stt_msk_ovr' };
    cfg.cmp_trl = { 'vis_frq_med' };
    cfg.cmp_stt = { [ 1 1 ] };
    cfg.cmp_nme = { { 'vis_lex_500ms' 'vis_lex_1200ms'} };
    cfg.cmp     = { { '251!252' '251!252' } };
...
if any(eve_typ > 9)
    ...
    cfg.alt_stt = { 'aud_frq_stt_msk_ovr' };
    cfg.cmp_trl = { 'aud_frq_med' };
    cfg.cmp_stt = { [ 1 1 ] };
    cfg.cmp_nme = { { 'aud_lex_500ms' 'aud_lex_1200ms'} };
    cfg.cmp     = { { '251!252' '251!252' } };
    cfg.tme_win = { { [0.025 0.500] [0.025 1.200] } };
