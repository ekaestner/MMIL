function iSASZ_pap_eff_hgp_trg_sem(fcfg)

fprintf([fcfg.sbj_nme ': Starting iSASZ_pap_eff_hgp_trg_sem on %s \n'],fcfg.sbj_nme)
...
if any(eve_typ < 9)
    ...
    cfg.cmp     = { { '901>902'       '901<902'       '901>902'        '901<902' } };
...
if any(eve_typ > 9)
    ...
    cfg.cmp     = { { '911>912'       '911<912'       '911>912'        '911<912' } };
    cfg.tme_win = { { [0.025 0.500]   [0.025 0.500]   [0.025 1.200]    [0.025 1.200] } };
