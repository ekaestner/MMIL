function iSASZ_pap_eff_lfp_rep(fcfg)

fprintf([fcfg.sbj_nme ': Starting iSASZ_pap_eff_lfp_rep on %s \n'],fcfg.sbj_nme)
...
if any(eve_typ < 9)
    ...
    cfg.alt_stt = { 'vis_new_old_stt' };
    cfg.cmp_trl = { 'vis_new_old' };
    cfg.cmp_stt = { [ 1 1 ] };
    cfg.cmp_nme = { { 'vis_rep_500ms' 'vis_rep_1200ms'} };
...
if any(eve_typ > 9)
    ...
    cfg.alt_stt = { 'aud_new_old_stt' };
    cfg.cmp_trl = { 'aud_new_old' };
    cfg.cmp_stt = { [ 1 1 ] };
    cfg.cmp_nme = { { 'aud_rep_500ms' 'aud_rep_1200ms'} };
