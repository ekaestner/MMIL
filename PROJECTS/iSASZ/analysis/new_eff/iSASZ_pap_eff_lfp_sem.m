function iSASZ_pap_eff_lfp_sem(fcfg)

fprintf([fcfg.sbj_nme ': Starting iSASZ_pap_eff_lfp_act on %s \n'],fcfg.sbj_nme)
...
if any(eve_typ < 9)
    ...
    cfg.cmp_stt = { [ 1 1 ] };
    cfg.cmp_nme = { { 'vis_sem_500ms' 'vis_sem_1200ms' } };
...
if any(eve_typ > 9)
    ...
    cfg.cmp_stt = { [ 1 1 ] };
    cfg.cmp_nme = { { 'aud_sem_500ms' 'aud_sem_1200ms' } };
    cfg.cmp     = { { '221!222'       '221!222'        } };
    cfg.tme_win = { { [0.025 0.500]   [0.025 1.200]    } };
