%% SZ NY05 Analysis Script - There is also a SZ2, not sure what that's about
clear; clc;
...
indir = '/space/mdeh3/7/halgdev/analysis/iEEG_NYU/NY05/NY05_SZ/eeg';
...
rmv_chn = numel(sem_dat.NY05_SZ.label)-3:numel(sem_dat.NY05_SZ.label);
