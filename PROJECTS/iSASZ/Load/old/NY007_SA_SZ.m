...
indir   = {'/space/mdeh3/7/halgdev/analysis/iEEG_NYU/NY07/NY07_SA/eeg' ...
           '/space/mdeh3/7/halgdev/analysis/iEEG_NYU/NY07/NY07_SZ/eeg'};
 
cln_dir = {'SAall' 'SZ'};

inpath_holder.(cln_dir{1}) = strsplit(ls([indir{1} '/' '*' cln_dir{1} '*.eeg']),'.eeg'); inpath_holder.(cln_dir{1})(2) = [];
...
rmv_chn = [rmv_chn numel(sem_dat.(sem_dat.data_name{1}).label)-2:numel(sem_dat.(sem_dat.data_name{1}).label)];
