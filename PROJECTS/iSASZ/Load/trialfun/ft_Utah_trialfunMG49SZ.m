...
% events/trigger value are extracted from SZ trigger data '/home/qdeng/qdeng/dataset/SZi-actual.csv'

function trl = ft_Utah_trialfunMG49SZ(data)

addpath(genpath('/home/qdeng/qdeng'));
addpath(genpath('/space/syn02/1/data/MMILDB/BACKUP/md7/1/pubsw/packages/MMPS/MMPS_236'));

data = load('/space/mdeh4/1/halgdev/projects/mmilanguage/TriggerChannel/MG49_SZ__Utah.mat');
...
pos = 1.5*Fs;
%% Find the timings
tmpdat = dat;    tmpdat([1:7.6e5])=0;   tmpdat([1.66e6:end])=0;
