...
for iS = 1:16
    ...
    cfg.str_nme  = 'sem_dat';
    cfg.save     = 'yes';
    cfg.filename = [abs_out_dir '/' sbj '_lfp_data.mat'];
    ft_func([],cfg,sem_dat);

end

%% Create Early & Late lfp divisions
clear; clc;
...
plt_dir = '/space/mdeh4/1/halgdev/projects/mmilanguage/iSASZ/epoch_data_abstract/lfp';
cpy_dir = '/space/mdeh4/1/halgdev/projects/mmilanguage/iSASZ/epoch_data_abstract/lfp/plt';

rmdir(cpy_dir,'s')
mkdir(cpy_dir)

% Find all files with 'repetition' in lfp visual folders
tmp_cpy = strsplit(ls([plt_dir '/' '*' '/' '*_rep_*']),'.png');
cellfun(@(x) copyfile([x '.png'],[cpy_dir]),tmp_cpy);

copyfile('/space/mdeh4/1/halgdev/projects/mmilanguage/iSASZ/epoch_data/initial_plot/repetition_effects/aud_vis_loc_hgp/NY09.ppt',cpy_dir)
copyfile('/space/mdeh4/1/halgdev/projects/mmilanguage/iSASZ/epoch_data/initial_plot/repetition_effects/aud_vis_loc_hgp/NY11.ppt',cpy_dir)
copyfile('/space/mdeh4/1/halgdev/projects/mmilanguage/iSASZ/epoch_data/initial_plot/repetition_effects/aud_vis_loc_hgp/NY16.ppt',cpy_dir)
