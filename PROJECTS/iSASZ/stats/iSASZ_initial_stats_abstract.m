...
infile = ['/space/mdeh4/1/halgdev/projects/mmilanguage/iSASZ/epoch_data_abstract/' subj '_overall_data.mat'];
...
if has_vis && has_aud
    ...
    cfg.clr_fld = '/space/mdeh4/1/halgdev/projects/mmilanguage/iSASZ/epoch_data_abstract/clerical';
    cfg.sbj_nme = subj;
