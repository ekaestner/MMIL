...
key_row = strcmpi(key_fle(:,1),bid_nme{1});

fcfg = [];
fcfg.dta_loc = [ prj_dir '/' 'new_data' '/' bid_nme{1} '/' 'covariates' '/' 'ENIGMAEpilepsy-CNN_DATA_2024-10-08_1139.csv'];
...
red_cap_ste = red_cap_dta(:,strcmpi(red_cap_col,'site'));
tot_ste = unique( red_cap_ste );
...
cell2csv([ prj_dir '/' 'new_data' '/' 'covariates' '/' 'site_table1_check' '_' dte_str '.csv'] ,[ {'Site'} cov_out_col ; [ {'Total'} ; tot_ste] cov_tbl]);
