function SL_pap_ana_lfp_lng(fcfg)

fprintf([fcfg.sbj_nme ': Starting SL_pap_ana_lfp_lng on %s \n'],fcfg.sbj_nme)
...
cfg.sig_loc = { { 'ovr_stt' 'ovr_stt' 'vis_nse_stt_msk_anv' 'aud_nse_stt_msk_anv' } };
...
cfg.stt_col = { { { ft_stt_col(rgb('grey')) ft_stt_col(rgb('greenish grey')) ft_stt_col(rgb('light red')) ft_stt_col(rgb('light blue'))  } } };
cfg.stt_cmp = { { { '0%5'                 '5%10'                            '1vs3'                 '1vs4' } } };
