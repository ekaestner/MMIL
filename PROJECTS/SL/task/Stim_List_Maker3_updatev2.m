...
%     end
    ...
    aud_stm_nse1{iW} = ['F_' lower(vis_stm1{iW})  '_matched_noise_TB12_Fc20-20000_nobroadband_log.wav'];
    
%     if isempty(strfind(vis_stm2{iW},'AH'))
        aud_stm_nse2{iW} = ['F_' lower(vis_stm2{iW})  '_matched_noise_TB12_Fc20-20000_nobroadband_log.wav'];
%     else
%         aud_stm_nse2{iW} = ['F_' lower(vis_stm2{iW}(1:end-1))  '_matched_noise_TB25_Fc20-20000.wav'];
%     end
end
for iW = 1:numel(vis_stm3)
    aud_stm3{iW} = ['F_' lower(vis_stm3{iW})  '.wav'];
    aud_stm_nse3{iW} = ['F_' lower(vis_stm3{iW})  '_matched_noise_TB12_Fc20-20000_nobroadband_log.wav'];
end
...
%     cv_ind_nse2 = find(strcmpi(aud_stm_nse2{iAS},cv_auditory_stimuli));
    ...
    copyfile(['/home/ekaestne/Downloads/CV_5_11_14/stimuli/' cv_auditory_stimuli{cv_ind1}],'/home/ekaestne/Desktop/Tasks/OrganizedTaskFolder/SL/SL_F_Stimuliv2')
    copyfile(['/home/ekaestne/Downloads/CV_5_11_14/stimuli/' cv_auditory_stimuli{cv_ind2}],'/home/ekaestne/Desktop/Tasks/OrganizedTaskFolder/SL/SL_F_Stimuliv2')
    copyfile(['/home/ekaestne/Downloads/CV_5_11_14/stimuli/' cv_auditory_stimuli{cv_ind3}],'/home/ekaestne/Desktop/Tasks/OrganizedTaskFolder/SL/SL_F_Stimuliv2')    
%     copyfile(['/home/ekaestne/Downloads/CV_5_11_14/stimuli/' cv_auditory_stimuli{cv_ind_nse1}],'/home/ekaestne/Desktop/Tasks/OrganizedTaskFolder/SL/SL_F_Stimuliv2')
%     copyfile(['/home/ekaestne/Downloads/CV_5_11_14/stimuli/' cv_auditory_stimuli{cv_ind_nse2}],'/home/ekaestne/Desktop/Tasks/OrganizedTaskFolder/SL/SL_F_Stimuliv2')
end
...
%     
%     copyfile(['/home/ekaestne/Downloads/CV_5_11_14/stimuli/' cv_auditory_stimuli{cv_ind_nse3}],'/home/ekaestne/Desktop/Tasks/OrganizedTaskFolder/SL/SL_F_Stimuliv2')
% end
 %% Make New Noise
Fc = [20 20000];
TB = 12;
...
out_str = sprintf('TB%d_Fc%d-%d',TB,Fc(1),Fc(2)); 

in_dir  = '/home/ekaestne/Desktop/Tasks/OrganizedTaskFolder/SL/SL_F_Stimuliv2';
out_dir = ['/home/ekaestne/Desktop/Tasks/OrganizedTaskFolder/SL/SL_F_Stimuliv2/noise/'] ;
dir_lst = dir([in_dir '/' '*.wav']);

stm_num = 1;
for i = 1:length(dir_lst)
    if ~dir_lst(i).isdir && findstr(dir_lst(i).name,'.wav')
        file = sprintf('%s/%s',in_dir,dir_lst(i).name);
        [scn,word] = GenerateSCN_v2_remove2(file,Fc,TB,Fs,out_dir,[20 20],out_str,SCN_lab,stm_num,wrt_flg,i);
        stm_num = stm_num + 1;
    end
end
 
 %% Make Spectrograms for Voices
 % Make Timings
stm = cat(2,vis_stm1,vis_stm2,vis_stm3);

for iCP = 1:numel(stm)
   copyfile(['/home/ekaestne/Desktop/Tasks/OrganizedTaskFolder/BG/Stimuli/Output' '/' 'F_' lower(stm{iCP}) '.txt'],['/space/mdeh4/1/halgdev/projects/mmilanguage/SL/stim/Timings/Female/Voicesv2' '/' 'F_' lower(stm{iCP}) '.txt']);
end

ttt.con1 = {'N' 'T' 'S' 'W'}; % 
ttt.vow1 = {'EE' 'UH' 'OH' 'AY'}; %

ttt.con2 = {'M' 'D' 'H' 'F'}; %
ttt.vow2 = {'EE' 'OO' 'AH' 'UR'}; %

ttt.con3 = {'L' 'Y' 'R' 'K'}; %
ttt.vow3 = {'EH' 'AW' 'OY' 'IH'}; %

f_vce_wav_fle = dir(['/home/ekaestne/Desktop/Tasks/OrganizedTaskFolder/SL/SL_F_Stimuliv2/' 'F' '*.wav']); f_vce_wav_fle = {f_vce_wav_fle(:).name};

f_vce_tme_fle = dir(['/space/mdeh4/1/halgdev/projects/mmilanguage/SL/stim/Timings/Female/Voicesv2/' '*.txt']); f_vce_tme_fle = {f_vce_tme_fle(:).name};
cmu_dic = mmil_readtext(['/home/ekaestne/Desktop/Tasks/OrganizedTaskFolder/BG/Stimuli' '/' 'CMU_Dictionary_Addon'],[' ']); cmu_dic(:,2) = [];
f_tme_hld = cell(numel(f_vce_tme_fle),3);
for iOF = 1:numel(f_vce_tme_fle)
      
    try f_txt_tmp = mmil_readtext(['/space/mdeh4/1/halgdev/projects/mmilanguage/SL/stim/Timings/Female/Voicesv2/' f_vce_tme_fle{iOF}]);
    catch; try f_txt_tmp = mmil_readtext(['/space/mdeh4/1/halgdev/projects/mmilanguage/SL/stim/Timings/Female/Voicesv2/' f_vce_tme_fle{iOF}(1:2)]);
    catch; f_txt_tmp = mmil_readtext(['/space/mdeh4/1/halgdev/projects/mmilanguage/SL/stim/Timings/Female/Voicesv2/' f_vce_tme_fle{iOF}(1:3)]); end;end
    ...
    if ~isempty(f_fst_phn_lne) && ~isempty(f_scd_phn_lne)
        ...
        f_tme_hld(iOF,:) = [f_vce_tme_fle{iOF}(1:end-4) f_fst_phn_tme f_scd_phn_tme];
    else
...
for iBL = 1:3;
    ...
    for iC = 1:numel(ttt.(['con' num2str(iBL)]))
        for iV = 1:numel(ttt.(['vow' num2str(iBL)]))
            ...
            tme_ind = find(strcmpi(['F_' lower(stm)],f_tme_hld(:,1)));
            
            subplot(4,4,cnt);
            
            [f_vce_wav,fs_f_vce_wav] = wavread(['/home/ekaestne/Desktop/Tasks/OrganizedTaskFolder/SL/SL_F_Stimuliv2/' '/' f_vce_wav_fle{wve_ind}]);
    ...
    print(['/home/ekaestne/Desktop/Tasks/OrganizedTaskFolder/SL/SL_F_Stimuliv2/Spectrograms' '/' 'F_Block' num2str(iBL) '_Bigrams.png'],'-dpng','-r300');
    close all
    
end

 %% Make Spectrograms for Noise
 f_vce_wav_fle = dir(['/home/ekaestne/Desktop/Tasks/OrganizedTaskFolder/SL/SL_F_Stimuliv2/noise/Log_NoBroad_20/' 'F' '*.wav']); f_vce_wav_fle = {f_vce_wav_fle(:).name};
 ...
 for iBL = 1:3;
    ...
    for iC = 1:numel(ttt.(['con' num2str(iBL)]))
        for iV = 1:numel(ttt.(['vow' num2str(iBL)]))
            ...
            wve_ind = find(strcmpi(f_vce_wav_fle,['F_' lower(stm) '_matched_noise_TB20_Fc20-20000_nobroadband_log.wav']));
            if isempty(wve_ind)
                wve_ind = find(strcmpi(f_vce_wav_fle,['F_' lower(stm(1:2)) '_matched_noise_TB20_Fc20-20000_nobroadband_log.wav']));
            end
            if isempty(wve_ind)
                wve_ind = find(strcmpi(f_vce_wav_fle,['F_' lower(stm(1:3)) '_matched_noise_TB20_Fc20-20000_nobroadband_log.wav']));
            end
            tme_ind = find(strcmpi(['F_' lower(stm)],f_tme_hld(:,1)));
            
            subplot(4,4,cnt);
            
            [f_vce_wav,fs_f_vce_wav] = wavread(['/home/ekaestne/Desktop/Tasks/OrganizedTaskFolder/SL/SL_F_Stimuliv2/noise/Log_NoBroad_20' '/' f_vce_wav_fle{wve_ind}]);
    ...
    print(['/home/ekaestne/Desktop/Tasks/OrganizedTaskFolder/SL/SL_F_Stimuliv2/Spectrograms' '/' 'F_Block' num2str(iBL) '_Noise.png'],'-dpng','-r300');
    close all
...
for iN = 1:4
    while ~out_cmp
        ...
        for iIN = 1:numel(vis_stm1)
            ...
            if fal < 50000;
                ...
                inc_aud_stm{iIN} = hld_aud_stm{inc_ind};
                inc_fut_vis_stm{iIN} = upper(hld_aud_stm{inc_ind}(3:5)); hld_aud_stm(inc_ind) = [];
    ...
    lst1.(['num_' num2str(iN)]) = [vis_stm1'        aud_stm1' num2cell(ones(numel(vis_stm1),1)*1) num2cell(inc_vis_con_num') num2cell(inc_vis_vow_num') num2cell(con_con_num1') num2cell(con_vow_num1'); ...
                                   ...
                                   inc_fut_vis_stm' aud_stm_nse1' num2cell(ones(numel(vis_stm1),1)*4) num2cell(inc_vis_con_num') num2cell(inc_vis_vow_num') num2cell(con_con_num1') num2cell(con_vow_num1')];
...
for iN = 1:4
    ...
    lst2.(['num_' num2str(iN)]) = [vis_stm2'        aud_stm2' num2cell(ones(numel(vis_stm2),1)*1) num2cell(inc_vis_con_num') num2cell(inc_vis_vow_num') num2cell(con_con_num2') num2cell(con_vow_num2'); ...
                                   ...
                                   inc_fut_vis_stm' aud_stm_nse2' num2cell(ones(numel(vis_stm2),1)*4) num2cell(inc_vis_con_num') num2cell(inc_vis_vow_num') num2cell(con_con_num2') num2cell(con_vow_num2')];
...
for iN = 1:4
    ...
    lst3.(['num_' num2str(iN)]) = [vis_stm3'        aud_stm3' num2cell(ones(numel(vis_stm3),1)*1) num2cell(inc_vis_con_num') num2cell(inc_vis_vow_num') num2cell(con_con_num3') num2cell(con_vow_num3'); ...
                                   ...
                                   inc_fut_vis_stm' aud_stm_nse3' num2cell(ones(numel(vis_stm3),1)*4) num2cell(inc_vis_con_num') num2cell(inc_vis_vow_num') num2cell(con_con_num3') num2cell(con_vow_num3')];
...
for iW = 1:numel(tst_stm)
    ...
    tst_stm_nse1{iW} = ['F_' lower(tst_stm{iW})  '_matched_noise_TB25_Fc20-20000.wav'];
