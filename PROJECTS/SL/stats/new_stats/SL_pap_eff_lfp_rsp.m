function SL_pap_eff_lfp_rsp(fcfg)
...
cfg.cmp_stt = { [ 1 1 1 ] ... 
                [ 2 2 2 ] };
cfg.cmp_nme = { { 'anv_500ms' 'anv_1000ms' 'anv_1500ms' } ; ... 
                { 'ovr_500ms' 'ovr_1000ms' 'ovr_1500ms'  } };  
cfg.cmp     = { { '101>999' '101>999' '101>999' } ... 
                { '1!2'     '1!2'     '1!2' } };
cfg.tme_win = { { [0.025 0.500] [0.475 0.950] [0.975 1.500] } ... 
                { [0.025 0.500] [0.475 0.950] [0.975 1.500] } };
cfg.stt_col = { { 'red'         'blue'        'green' } ... 
                { 'red'         'blue'        'green' } };
