...
reg.cmb_reg.mtg = { 'Caudal MTG' 'Middle MTG' 'Rostral MTG'};
reg.cmb_reg.stg = { 'Caudal STG' 'Middle STG' 'Rostral STG'};
...
reg.cmb_reg.mid = { 'Rostral Middle Frontal' 'Middle Middle Frontal' 'caudalmiddlefrontal' };
...
cfg.trg_pct = 0.5;
cfg.pvl_dir = 'lesser';
vis_and_aud_tot = mmil_ovr_lap_ele(cfg);
...
cfg.trg_pct = 0.5;
cfg.pvl_dir = 'greater';
vis_and_mtc_tot = mmil_ovr_lap_ele(cfg);
...
cfg.trg_pct = 0.5;
cfg.pvl_dir = 'greater';
aud_and_mtc_tot = mmil_ovr_lap_ele(cfg);
...
cfg.trg_pct = 0.5;
cfg.pvl_dir = 'greater';
fls_and_mtc_tot = mmil_ovr_lap_ele(cfg);
...
cfg.trg_pct = 0.5;
cfg.pvl_dir = 'greater';
nse_and_mtc_tot = mmil_ovr_lap_ele(cfg);

[ vis_and_mtc_tot.lhs(end,:) ; aud_and_mtc_tot.lhs(end,:) ; fls_and_mtc_tot.lhs(end,:) ; nse_and_mtc_tot.lhs(end,:) ]
[ vis_and_mtc_tot.rhs(end,:) ; aud_and_mtc_tot.rhs(end,:) ; fls_and_mtc_tot.rhs(end,:) ; nse_and_mtc_tot.rhs(end,:) ]

%
lbl = [lng_ovr_lap(1,:) '' con_ovr_lap(1,:) '' mtc_ovr_lap(1,:) ];

lng_ovr_lap = lng_ovr_lap(2:end,:);
con_ovr_lap = con_ovr_lap(2:end,:);
mtc_ovr_lap = mtc_ovr_lap(2:end,:);

vis_and_aud_and_mtc = lng_ovr_lap(cell2mat(lng_ovr_lap(:,3)) & cell2mat(lng_ovr_lap(:,4)) & cell2mat(mtc_ovr_lap(:,3)),2);
vis_and_mtc = lng_ovr_lap(cell2mat(lng_ovr_lap(:,3)) & cell2mat(mtc_ovr_lap(:,3)),2);
aud_and_mtc = lng_ovr_lap(cell2mat(lng_ovr_lap(:,4)) & cell2mat(mtc_ovr_lap(:,3)),2);
fls_and_mtc = lng_ovr_lap(cell2mat(con_ovr_lap(:,3)) & cell2mat(mtc_ovr_lap(:,3)),2);
nse_and_mtc = lng_ovr_lap(cell2mat(con_ovr_lap(:,4)) & cell2mat(mtc_ovr_lap(:,3)),2);
non_and_mtc = lng_ovr_lap(~cell2mat(lng_ovr_lap(:,3)) & ~cell2mat(lng_ovr_lap(:,4)) & ~cell2mat(con_ovr_lap(:,3)) & ~cell2mat(con_ovr_lap(:,4)) & cell2mat(mtc_ovr_lap(:,3)),2);
...
cfg.trg_pct = 0.5;
vis_and_nse = mmil_ovr_lap_ele_v2(cfg);
...
cfg.trg_pct = 0.5;
cfg.pvl_dir = 'greater';
aud_and_fls = mmil_ovr_lap_ele_v2(cfg);

%
lbl = [lng_ovr_lap(1,:) '' con_ovr_lap(1,:) ];

lng_ovr_lap = lng_ovr_lap(2:end,:);
con_ovr_lap = con_ovr_lap(2:end,:);

vis_and_fls_lbl = lng_ovr_lap(cell2mat(lng_ovr_lap(:,3)) & cell2mat(con_ovr_lap(:,3)),2);
vis_and_nse_lbl = lng_ovr_lap(cell2mat(lng_ovr_lap(:,3)) & cell2mat(con_ovr_lap(:,4)),2);

aud_and_fls_lbl = lng_ovr_lap(cell2mat(lng_ovr_lap(:,4)) & cell2mat(con_ovr_lap(:,3)),2);
aud_and_nse_lbl = lng_ovr_lap(cell2mat(lng_ovr_lap(:,4)) & cell2mat(con_ovr_lap(:,4)),2);

vis_and_aud_fls_lbl = lng_ovr_lap( cell2mat(lng_ovr_lap(:,3)) & cell2mat(lng_ovr_lap(:,4)) & cell2mat(con_ovr_lap(:,3)),2);
vis_and_aud_nse_lbl = lng_ovr_lap( cell2mat(lng_ovr_lap(:,3)) & cell2mat(lng_ovr_lap(:,4)) & cell2mat(con_ovr_lap(:,4)),2);
