...
vow_ind = {101:104 105:108 109:112};
...
stt_nme = {'aud_vow_blk1' 'aud_vow_blk2' 'aud_vow_blk3' 'aud_con_blk1' 'aud_con_blk2' 'aud_con_blk3' 'aud_int_blk1' 'aud_int_blk2' 'aud_int_blk3'};
for iCF = 1:numel(stt_nme)
    stt_dat.cfg.alt_stt.(stt_nme{iCF}) = mmil_addscript(stt_dat.cfg.alt_stt.(stt_nme{iCF}),'stats');
end
