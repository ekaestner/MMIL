...
infile = [fcfg.out_pth sbj '_overall_data_depth.mat'];
...
cfg = [];
cfg.load = 'yes';
cfg.file = [outpath '/' sbj '_overall_data_depth.mat'];
bcc_dat  = ft_func([],cfg);
...
cfg.save     = 'yes';
cfg.sve_app  = 'app_all';
cfg.filename = [outpath '/' sbj '_overall_data_depth.mat'];
ft_func([],cfg,bcc_dat);
