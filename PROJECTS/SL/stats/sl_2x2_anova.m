...
cfg.nofig      = 1;
cfg.print_type = 'jpg';
cfg.outdir     = ['/space/mdeh4/1/halgdev/projects/mmilanguage/SL/epoch_data_cmb/initial_plot' '/'  subj '/' 'Aud2x2_filtered' '/'];
cfg.prefix     = 'Aud_2x2_Phoneme';
mmil_ieeg_sensor_plot_v4(cfg)

save(['/space/mdeh4/1/halgdev/projects/mmilanguage/SL/epoch_data_cmb' '/' subj '_2x2anova_filtered.mat'],'anv_dat')
...
cfg.nofig      = 1;
cfg.print_type = 'jpg';
cfg.outdir     = ['/space/mdeh4/1/halgdev/projects/mmilanguage/SL/epoch_data_cmb/initial_plot' '/'  subj '/' 'Vis2x2_filtered' '/'];
...
cfg.nofig      = 1;
cfg.print_type = 'jpg';
cfg.outdir     = ['/space/mdeh4/1/halgdev/projects/mmilanguage/SL/epoch_data_cmb/initial_plot' '/'  subj '/' 'Aud2x2_filtered' '/' 'noise'];
cfg.prefix     = 'Aud_2x2_Phoneme';
mmil_ieeg_sensor_plot_v4(cfg)
...
cfg.nofig      = 1;
cfg.print_type = 'jpg';
cfg.outdir     = ['/space/mdeh4/1/halgdev/projects/mmilanguage/SL/epoch_data_cmb/initial_plot' '/'  subj '/' 'Vis2x2_filtered' '/' 'noise'];
cfg.prefix     = 'Vis_2x2_Phoneme';
mmil_ieeg_sensor_plot_v4(cfg)
