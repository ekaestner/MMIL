%% Project locations %%%%%%%%%%%%%%%%%%%%%%%
prj_dir = '/home/ekaestner/Dropbox/McDonald Lab/Erik/Projects/Imaging/slh_atl_mem_v2/';

dta_dir = [ prj_dir '/' 'Data' '/' ];
dta_cph = 'demographic_variables.csv';

%% Demographics / Clinical
red_cap_fle = 'Redcap_2023_03_17.csv';

emy_cog_fle = 'LMforErik_2023_04_04_add_Dan.csv';
emy_dem_fle = 'demographic_variables_RR.csv';

%% Imaging
mri_fle     = 'MRI_all_2023_05_11.csv';
dti_all_fle = 'DTI_all_2023_05_11.csv';
...
%
mri_dev_fle     = [ dta_dir '/' 'MRI_all_2023_05_11.csv' ];
dti_dev_fle     = [ dta_dir '/' 'DTI_all_2023_05_11.csv' ];
...
mri_var_int     = { {'Hippocampus' 'Thalamus'} ...
                    {'fusiform' 'lateralorbitofrontal'} };
...
dti_dev_lat     = [ 1              1          1 ];
dti_dev_icv     = { ''             ''         '' };
dti_var_int     = { {'fusiform' 'lateralorbitofrontal'} ...
                    {'ILF' 'Unc'} ...
                    {'fusiform' 'lateralorbitofrontal'} };
