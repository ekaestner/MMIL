...
sve_cmd = sprintf('%ssource(''/home/ekaestner/gitrep/MMIL/ejk/R/R/ejk_cross_cor_robust.r'')\n',sve_cmd);
sve_cmd = sprintf('%sejk_cross_cor_robust( ''%s/dta_one.mat'', ''%s/dta_two.mat'', ''%s'', %f, %f)', sve_cmd, ejk_fix_path(cfg.out_dir), ejk_fix_path(cfg.out_dir), ejk_fix_path(cfg.out_dir), cfg.pvl_cut, cfg.pvl_lib);
