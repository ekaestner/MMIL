...
if ~isfield(cfg,'srf_typ'); cfg.srf_typ = 'pial'; end
...
if isfield(cfg,'hme_wrk') && cfg.hme_wrk == 1
    lhs_surf_brain.surf_brain =  fs_read_surf(['/home/ekaestne/PROJECTS/EXTERNAL/Misc/fsaverage/surf/' '/' cfg.lhs_nme '.' cfg.srf_typ]);
    ...
    rhs_surf_brain.surf_brain =  fs_read_surf(['/home/ekaestne/PROJECTS/EXTERNAL/Misc/fsaverage/surf/' '/' cfg.rhs_nme '.' cfg.srf_typ]);
...
elseif isfield(cfg,'fsr_dir') && ~isempty(cfg.fsr_dir)
    ...
    rhs_surf_brain.surf_brain =  fs_read_surf(['/home/mmilmcd/data/FSRECONS/fsaverage/' '/' 'surf' '/' cfg.rhs_nme '.' cfg.srf_typ]);
    rhs_surf_brain.surf_brain.coords = rhs_surf_brain.surf_brain.vertices;
