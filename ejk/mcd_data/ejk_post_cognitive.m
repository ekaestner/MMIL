    ...
    for iFN = 1:numel(raw_pre_cog_fld_nme)
        switch raw_pre_cog_fld_nme{iFN}
            case 'log_mem_raw_scr_one'
                pst_cog_scr.log_mem_nor_scr_one_pst = ( ( cog_dta.log_mem_nor_scr_one_pst - cog_dta.log_mem_nor_scr_one ) - (12.1-10.2) ) / 2.14;
            case 'log_mem_raw_scr_two'
                pst_cog_scr.log_mem_nor_scr_two_pst = ( ( cog_dta.log_mem_nor_scr_two_pst - cog_dta.log_mem_nor_scr_two ) - (12.5-10.2) ) / 2.07;
            case 'cvl_lfr_raw_scr'
                pst_cog_scr.cvl_lfr_raw_scr_pst     = ( ( cog_dta.cvl_lfr_raw_scr_pst - cog_dta.cvl_lfr_raw_scr ) - (11.74-10.19) ) / 1.86;
            case 'vp1_raw_scr'
                pst_cog_scr.vp1_nor_scr_pst         = ( ( cog_dta.vp1_nor_scr_pst - cog_dta.vp1_nor_scr ) - (11.8-10.4) ) / 1.94;
            case 'vp2_raw_scr'
                pst_cog_scr.vp2_nor_scr_pst         = ( ( cog_dta.vp2_nor_scr_pst - cog_dta.vp2_nor_scr ) - (11.1-10.5) ) / 1.88;
            case 'bnt_raw_scr'
                pst_cog_scr.bnt_raw_scr_pst         = ( ( cog_dta.bnt_raw_scr_pst - cog_dta.bnt_raw_scr ) - (50.06 - 48.78) ) / 2.67;
            case 'ant_mem_raw_scr'
                pst_cog_scr.ant_mem_raw_scr_pst     = ( ( cog_dta.ant_mem_raw_scr_pst - cog_dta.ant_mem_raw_scr ) - (49.42-49.08) ) / 1.09;
            case 'cat_flu_raw_scr'
                pst_cog_scr.cat_flu_nor_scr_pst     = ( ( cog_dta.cat_flu_nor_scr_pst - cog_dta.cat_flu_nor_scr ) - (10.3-9.83) ) / 2.15;
            case 'cvl_tot_raw_scr'
                pst_cog_scr.cvl_tot_raw_scr_pst     = ( ( cog_dta.cvl_tot_raw_scr_pst - cog_dta.cvl_tot_raw_scr ) - (56.05-47.92) ) / 7.65;
            case 'ltr_tot_raw_scr'
                pst_cog_scr.ltr_tot_nor_scr_pst     = ( ( cog_dta.ltr_tot_nor_scr_pst - cog_dta.ltr_tot_nor_scr ) - (10.1-9.62) ) / 2.11;
            case 'swt_cor_raw_scr'
                pst_cog_scr.swt_cor_nor_scr_pst     = ( ( cog_dta.swt_cor_nor_scr_pst - cog_dta.swt_cor_nor_scr ) - (9.87-9.86) ) / 3.42;
            case 'swt_acc_raw_scr'
                pst_cog_scr.swt_acc_nor_scr_pst     = ( ( cog_dta.swt_acc_nor_scr_pst - cog_dta.swt_acc_nor_scr ) - (10.54-10.41) ) / 3.75;
        end
    end
elseif ~cfg.rci
    for iFN = 1:numel(raw_pre_cog_fld_nme)
        switch raw_pre_cog_fld_nme{iFN}
            case 'log_mem_raw_scr_one'
                pst_cog_scr.log_mem_nor_scr_one_pst = ( cog_dta.log_mem_nor_scr_one_pst - cog_dta.log_mem_nor_scr_one );
            case 'log_mem_raw_scr_two'
                pst_cog_scr.log_mem_nor_scr_two_pst = ( cog_dta.log_mem_nor_scr_two_pst - cog_dta.log_mem_nor_scr_two );
            case 'cvl_lfr_raw_scr'
                pst_cog_scr.cvl_lfr_raw_scr_pst     = ( cog_dta.cvl_lfr_raw_scr_pst - cog_dta.cvl_lfr_raw_scr );
            case 'vp1_raw_scr'
                pst_cog_scr.vp1_nor_scr_pst         = ( cog_dta.vp1_nor_scr_pst - cog_dta.vp1_nor_scr );
            case 'vp2_raw_scr'
                pst_cog_scr.vp2_nor_scr_pst         = ( cog_dta.vp2_nor_scr_pst - cog_dta.vp2_nor_scr );
            case 'bnt_raw_scr'
                pst_cog_scr.bnt_nor_scr_pst         = ( cog_dta.bnt_nor_scr_pst - cog_dta.bnt_nor_scr );
            case 'ant_mem_raw_scr'
                pst_cog_scr.ant_mem_raw_scr_pst     = ( cog_dta.ant_mem_raw_scr_pst - cog_dta.ant_mem_raw_scr );
            case 'cat_flu_raw_scr'
                pst_cog_scr.cat_flu_nor_scr_pst     = ( cog_dta.cat_flu_nor_scr_pst - cog_dta.cat_flu_nor_scr );
            case 'cvl_tot_raw_scr'
                pst_cog_scr.cvl_tot_raw_scr_pst     = ( cog_dta.cvl_tot_raw_scr_pst - cog_dta.cvl_tot_raw_scr );
            case 'ltr_tot_raw_scr'
                pst_cog_scr.ltr_tot_nor_scr_pst     = ( cog_dta.ltr_tot_nor_scr_pst - cog_dta.ltr_tot_nor_scr );
            case 'swt_cor_raw_scr'
                pst_cog_scr.swt_cor_nor_scr_pst     = ( cog_dta.swt_cor_nor_scr_pst - cog_dta.swt_cor_nor_scr );
            case 'swt_acc_raw_scr'
                pst_cog_scr.swt_acc_nor_scr_pst     = ( cog_dta.swt_acc_nor_scr_pst - cog_dta.swt_acc_nor_scr );
        end
    end
end
...
lrn_nme = { 'log_mem_nor_scr_one_pst' 'cvl_tot_raw_scr_pst' 'vp1_nor_scr_pst'};
mem_nme = { 'log_mem_nor_scr_two_pst' 'cvl_lfr_raw_scr_pst' 'vp2_nor_scr_pst' };
lng_nme = { 'bnt_raw_scr_pst'         'ant_mem_raw_scr_pst' 'cat_flu_nor_scr_pst' };
frn_nme = { 'ltr_tot_nor_scr_pst'     'swt_cor_nor_scr_pst' 'swt_acc_nor_scr_pst' };
