...
int main(int argc, char** argv)
{
  ...
  */
  ...
  pStatistical->importMeanTemplate(surfaceType, 
				   templateInputDirectory); 


  pStatistical->importMeanSurface(surfaceType, 
				  meanSurfaceInputDirectory); 

  pStatistical->importEof(surfaceType, 
			  eofInputDirectory); 


  pStatistical->optimizeCoefficient(); 
  pStatistical->moveEof(); 

  pStatistical->exportSurface(rasShift=NO, 
  ...
  pStatistical->createBorderMap(3.,1); 
