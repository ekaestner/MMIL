function [arg_groups,extra_tags,strip_flag] = mmil_args_MMIL_Check_ProjID()
%function [arg_groups,extra_tags,strip_flag] = mmil_args_MMIL_Check_ProjID()
%
...
arg_groups = [];
extra_tags = {'RootDirs' 'StudyInfo' 'VisitIDs' 'SubjIDs'...
 'user' 'ignore_VisitInfo_flag' 'checkflag' 'qcflag' 'modality'...
 'required_containers' 'required_rootdirs' 'ico' 'numvec_tags' ...
