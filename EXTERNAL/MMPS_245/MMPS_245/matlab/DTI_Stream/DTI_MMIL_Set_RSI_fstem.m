function [fstem,snums] = DTI_MMIL_Set_RSI_fstem(ContainerPath,varargin)
%function [fstem,snums] = DTI_MMIL_Set_RSI_fstem(ContainerPath,[options])
%
% Usage:
%  [fstem,snums] = ...
%     DTI_MMIL_Set_RSI_fstem(ContainerPath,'key1', value1,...);
%
% Required Parameters:
...
%
% Output:
%   fstem: full path file stem for RSI calculation output files
%   snums: vector of scan numbers used for RSI calculations
%
