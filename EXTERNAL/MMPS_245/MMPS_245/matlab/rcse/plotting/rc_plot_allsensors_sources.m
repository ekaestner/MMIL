function rc_plot_sensors_sources(prefix,alldips_flag)
%function rc_plot_sensors_sources(prefix,[alldips_flag])
%
% Purpose: plot locations of MEG and EEG sensors relative
%   to sources
%
% Required Input:
%   prefix: RCSE prefix
...
% todo: eeg_flag to make rc_plot_MEG_sensors_sources unnecessary
