...
mfaces = size(fv.faces,1); %number of triangles
...
e1 = (fv.vertices(fv.faces(:,2),:) - fv.vertices(fv.faces(:,1),:))'; % 3 x m
e2 = (fv.vertices(fv.faces(:,3),:) - fv.vertices(fv.faces(:,1),:))'; % 3 x m
...
T = r(:,ones(1,length(ndx))) - fv.vertices(fv.faces(ndx,1),:)';
