function [dipole_info,dec_dipole]=read_dipdec(dip_file, dec_file, varargin)

% read_dipdec	read in dip and dec files
%
% [dipole_info,dec_dipole]=read_dipdec(dip_file, dec_file)
%
% read dip and dec file for the location and orientation of the dipoles into matlab
%
% May. 7, 2005 by T Song, M.X. Huang
%
