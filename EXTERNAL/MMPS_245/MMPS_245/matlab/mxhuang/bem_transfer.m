function [return_var,varagout] = bem_transfer(R_eeg,R_meg,O_meg,vertices,faces,sigma,mode, ...
    basis_opt,test_opt,ISA,fn_eeg,fn_meg,NVertMax,Verbose)
%BEM_TRANSFER - Computation of the MEG and/or EEG BEM transfer matrices
% function [return_var,varagout] = bem_transfer(R_eeg,R_meg,O_meg,vertices,faces,sigma,mode, ...
%     basis_opt,test_opt,ISA,fn_eeg,fn_meg,NVertMax,Verbose)
% function [Te_ISA,Te,Tm_ISA,Tm,nfv] = bem_transfer(R_eeg,R_meg,O_meg,vertices,faces,sigma,mode, ...
%     basis_opt,test_opt,ISA,fn_eeg,fn_meg,NVertMax,Verbose)
%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%
%
% EEG/MEG FORWARD MODEL USING BOUNDARY ELEMENT METHODS
%                      - TRANSFER MATRIX CALCULATION (bem_transfer.m)
%
...
%       sigma  : conductivity from INNERMOST to OUTERMOST        (1 x NL)
...
%
%    varagout    : a surface tessellation structure with fields .vertices and
...
%
% Adding return_var to the output, M. Huang
%
