...
switch headerID
    ...
    case 'qraw'
        ...
        error('quick read mode is not supported');
    ...
    if (hdr_sizes_file)
        ...
        if hdr_szs(1) ~= -1
            ...
            if hdr_szs(1) ~= -1
                ...
                error('The pfile revision was not found in the header definition file "hdr_sizes.txt"');
            end
        end
    else
        error('hdr_sizes.txt file not found. This file is needed to relate the pfile rev to header offsets');
    end
end
return;
%---------------------------------------------------------------------
