function ctx_vol_res = ctx_resample_to_LIA(ctx_vol,M_reg,interpm,bclamp)
%function ctx_vol_res = ctx_resample_to_LIA(ctx_vol,M_reg,[interpm],[bclamp])
%
% like ctx_resample_to_ILA,  but resample to LIA instead of ILA
% like ctx_resample_to_ILA,  but resample using M_reg
%                             rather than just changing dim order
%
...
%
% Created:  01/16/09 by Don Hagler
