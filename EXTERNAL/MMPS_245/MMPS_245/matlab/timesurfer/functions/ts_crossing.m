function [ind,t0,s0,t0close,s0close] = ts_crossing(S,t,level,imeth)
% This function finds the nearest times a signal crosses a level (or 0)
% threshold. It is used to decode digital trigger channels.

% [ This is the orignal author notes for the 'CROSSING' function...
...
% This file was imported from Matlab Central file exchange.
% Then it was modified by Jason Sherfey on 10 June 2010.
% Last Mod: 26 Mar 2012, Renamed 'crossing' function ts_crossing to be consistent with timesurfer conventions, SRD.
