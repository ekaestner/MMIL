function [scan3dd] = elec_load_scan3ddasc(filename)

% elec_load_scan3ddasc - read ascii export of Neuroscan 3DD file
% 
...
%
% [scan3dd] = elec_load_scan3ddasc(filename)
% 
% where:
% 
...
% $Revision: 1.4 $ $Date: 2003/07/26 22:43:55 $
