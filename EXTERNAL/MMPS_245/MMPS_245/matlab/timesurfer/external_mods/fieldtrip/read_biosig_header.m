function [hdr] = read_biosig_header(filename, varargin)
...
%
% Last Mod: SRD 083012 Added option overflow_detect to force 'OVERFLOWDETECTION:OFF' for ts_loadedf.
