function [dat] = read_biosig_data(filename, hdr, begsample, endsample, chanindx, varargin);
...
%
% Last Mod: SRD 083012 Added optional no_ofd parameter to force 'OVERFLOWDETECTION:OFF' for ts_loadedf.
