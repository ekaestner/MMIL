...
# script for quality control (QC) of AtlasTrack fseg (and DTI FA reg to T1)
...
SetDisplayFlag 15 1 # turn on fseg
SetDisplayFlag 16 1 # turn on fseg

SetOrientation 2
SetSlice 100; RedrawScreen;
after 500
SetSlice 132; RedrawScreen;
after 500
SetSlice 145 ; RedrawScreen;
after 500
SetOrientation 1
SetSlice 140; RedrawScreen;
after 500
SetSlice 120; RedrawScreen;
after 500;
SetOrientation 0
SetSlice 137; RedrawScreen;
after 500
SetSlice 145; RedrawScreen;
after 500
SetSlice 130; RedrawScreen;
after 500
