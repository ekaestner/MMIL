        ...
        if ~isempty(strfind(ele_txt{1},';'));
            ...
            for iC = 1:numel(ele_txt);
                for iN = 1:numel(ele_txt{iC});
                    if strcmpi(ele_txt{iC}{iN},'[]') || strcmpi(ele_txt{iC}{iN},'{}');
                        ...
                        tmp = str2num(ele_txt{iC}{iN}); if ~isempty(tmp) & ~isnan(tmp); ele_txt{iC}{iN} = str2num(ele_txt{iC}{iN}); end
                    end
                end;
            end;
            ...
            for iC = 1:numel(ele_txt);
                if strcmpi(ele_txt{iC},'[]') || strcmpi(ele_txt{iC},'{}'); ele_txt{iC} = [];
                    ...
                    tmp = str2num(ele_txt{iC}); if ~isempty(tmp) & ~isnan(tmp); ele_txt{iC} = str2num(ele_txt{iC}); end;
                end;
            end
        end
    else
