...
# modified by Don Hagler 08/22/06
#############################################################################
...
if (("$1" == "--help") || ("$1" == "-help")) then
    ...
    echo "6. If NO_FSL is set (to anything), "
    echo "   then the FSL stuff is ignored."
    echo "7. The script will print the final settings for the above "
...
if((! $?NO_FSL) && (! $?FSL_DIR  || $FS_OVERRIDE)) then
