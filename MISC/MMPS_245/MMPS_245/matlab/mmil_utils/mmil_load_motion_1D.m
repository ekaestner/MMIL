function motion_data = mmil_load_motion(fname_motion,varargin)
%function motion_data = mmil_load_motion(fname_motion,varargin)
%
% Purpose: load motion.1D file from AFNI's 3dvolreg
%
% Usage:
...
% change rotations to be clockwise
motion_data(:,4:6) = -motion_data(:,4:6);
