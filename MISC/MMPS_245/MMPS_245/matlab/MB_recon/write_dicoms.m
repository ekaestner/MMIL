function [ ] = write_dicoms(img,sl, slice_demux_coord, dataFileHeader, t_array, num_t2, dcmfile, maxval, new_seuid, outdir)
...
%   Detailed explanation goes here
    ...
    outname=sprintf('%s/E%dS%dI',outdir, dataFileHeader.exam.ex_no, dataFileHeader.series.se_no*100);
    ...
    for t=1:length(t_array)
        ...
        metadata1.SeriesDescription = ['RM-AW ' metadata.SeriesDescription];
