% ts_iEEG_loadavg() - loading eeg average data file from Neuroscan into
%             matlab. 
%
% Usage:
%  >> [signal, variance, chan_names, ...
%               pnts, rate, xmin, xmax,nsweeps] = rp_loadavg( filename );
%
% Inputs:
...
% Initial revision
%
% Modified 08/31/2007 Rajan Patel
%  Added output of nsweeps to retrieve num of trials

function [signal, variance, chan_names, pnts, rate, xmin, xmax,nsweeps]=ts_iEEG_loadavg( FILENAME)
