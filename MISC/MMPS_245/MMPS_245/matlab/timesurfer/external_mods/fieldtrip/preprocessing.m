function [data] = preprocessing(cfg, data, varargin);
...
% Last Mod SRD 083012: Added varargin, and the cfg.overflow_detect field to allow disabling overflow detection.

% set the defaults
if ~isfield(cfg, 'overflow_detect'), cfg.overflow_detect = 1;   end %%%%% SRD 083012
...
if nargin>1
  ...
  % read the header
  hdr = read_header(cfg.headerfile, 'overflow_detect', cfg.overflow_detect); %%%%% SRD 083012
  ...
  for i=1:ntrl
    ...
    dat = read_data(cfg.datafile, hdr, begsample, endsample, rawindx, strcmp(cfg.continuous, 'yes'), 'overflow_detect', cfg.overflow_detect); %%%%% SRD 083012
