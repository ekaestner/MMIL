function h = mmil_welch(x,varargin)
...
cd('/space/syn02/1/data/MMILDB/BACKUP/md7/1/pubsw/packages/matlab/R2012b/toolbox/signal/signal/private')
...
if nargin > 1 & ischar(varargin{end}) & strcmpi(varargin{end},'ms'), %#ok
    esttype = 'ms';
    varargin(end)=[];
end
