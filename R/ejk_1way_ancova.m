...
%
% cfg.cov     = sbj-by-cov cell and/or matrix of group memberships
%
...
sve_cmd = sprintf('%ssource(''/home/ekaestner/gitrep/MMIL/R/ejk_1way_ancova.r'')\n',sve_cmd);
sve_cmd = sprintf('%sejk_1way_ancova( ''%s/dep_var.mat'', ''%s/grp_var.mat'', ''%s/cov_var.mat'', ''%s'' )', sve_cmd, cfg.out_dir, cfg.out_dir, cfg.out_dir, cfg.out_dir);
